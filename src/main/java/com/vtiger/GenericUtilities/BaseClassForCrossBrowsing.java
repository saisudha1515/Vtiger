...
public class BaseClassForCrossBrowsing {
	...
	public void bcConfig(String BROWSER) throws Throwable { // the parameter name "browser" is having value like dataprovider so we need to pass this browser value to the @Test Method..
